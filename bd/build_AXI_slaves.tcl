...
proc ADD_AXI_SLAVES { } {
    ...
    #    [AXI_DEVICE_ADD C2C1_LITE axi_interconnect_0/M07_AXI axi_interconnect_0/M07_ACLK axi_interconnect_0/M07_ARESETN 50000000]    
...
#####    set_property CONFIG.C_AXI_STB_WIDTH {8}         [get_bd_cells $device_name]
#####    set_property CONFIG.C_AXI_DATA_WIDTH {64}	    [get_bd_cells $device_name]
#####    set_property CONFIG.C_NUM_OF_IO {88.0}	    [get_bd_cells $device_name]
...
#####    set_property CONFIG.C_AURORA_WIDTH {2.0}        [get_bd_cells $device_name]
